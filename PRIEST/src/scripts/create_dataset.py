...
def main(subtype):
  ...
  print(data_path)
  BASE = '/home/gourab/Projects/CoV research/Tempel-modified/source_code/data/'
  if subtype_flag == 0:
      file_name = BASE + 'processed/H1N1/triplet_'
  elif subtype_flag == 1:
      file_name = BASE + 'processed/H3N2/triplet_'
  elif subtype_flag == 2:
      file_name = BASE + 'processed/H5N1/triplet_'
  parameters = {
...
#    test_strains_by_year = cluster.sample_from_clusters(test_strains_by_year, test_clusters_by_year, parameters['testing_samples'], verbose=True)
  ...
  # print(f'train strains: {len(train_strains_by_year)}x{len(train_strains_by_year[0])}x{len(train_strains_by_year[0][0])}')
...
def create_triplet_trigram_dataset(strains_by_year, trigram_to_idx, epitope_positions, file_name):
  ...
  print(file_name)
  # print('-----------------------')
  # print(type(strains_by_year))
  # print(len(strains_by_year))
  # print(type(strains_by_year[0]))
  # print(len(strains_by_year[0]))
  # print(type(strains_by_year[0][0]))
  # print(strains_by_year[0][1])
  # print(strains_by_year[0][2])
  # print(strains_by_year[0][3])
  # print(len(strains_by_year[0][0]))
  # print('-----------------------')
  triplet_strains_by_year = build_features.make_triplet_strains(strains_by_year, epitope_positions)
  # print('-----------------------')
  # print(type(triplet_strains_by_year))
  # print(len(triplet_strains_by_year))
  # print(type(triplet_strains_by_year[0]))
  # print(len(triplet_strains_by_year[0]))
  # print(type(triplet_strains_by_year[0][0]))
  # print(triplet_strains_by_year[0][1])
  # print(triplet_strains_by_year[0][2])
  # print(triplet_strains_by_year[0][3])
  # print(len(triplet_strains_by_year[0][0]))
  # print('-----------------------')
  trigrams_by_year = build_features.split_to_trigrams(triplet_strains_by_year)
  # print('-----------------------')
  # print(type(trigrams_by_year))
  # print(len(trigrams_by_year))
  # print(type(trigrams_by_year[0]))
  # print(len(trigrams_by_year[0]))
  # print(type(trigrams_by_year[0][0]))
  # print(len(trigrams_by_year[0][0]))
  # print(type(trigrams_by_year[0][0][0]))
  # print('-----------------------')
